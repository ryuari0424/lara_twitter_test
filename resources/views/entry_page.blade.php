                            ...
                            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                                <div class="px-4 py-8 sm:px-10">
                                    <form class="space-y-6" action="{{ route('login') }}" method="POST">
                                        @csrf
                                        <div>
                                            <label for="email" class="font-semibold leading-none tracking-tighter text-neutral-600 "> Email address </label>
                                            <div class="mt-1">
                                        ...
                                        <div>
                                            <label for="password" class="font-semibold leading-none tracking-tighter text-neutral-600"> Password </label>
                                            <div class="mt-1">
